...
function LoadPage() {
    ...
    $.getJSON("js/lang.json", function (langArray) {
        ...
        $('#participations').html(langObject.participations);
        $('#part-1-title').html(langObject.part_1_title);
        $('#part-1-desc').html(langObject.part_1_desc);
        $('#part-2-title').html(langObject.part_2_title);
        $('#part-2-desc').html(langObject.part_2_desc);
        $('#courses').html(langObject.courses);
        $('#course-1-title').html(langObject.course_1_title);
        $('#course-2-title').html(langObject.course_2_title);
        $('#course-3-title').html(langObject.course_3_title);
